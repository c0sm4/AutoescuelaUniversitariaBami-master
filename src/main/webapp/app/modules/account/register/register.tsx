...
export const RegisterPage = () => {
  ...
  const handleValidSubmit = ({ username, email, firstPassword }) => {
    dispatch(
      handleRegister({ login: username, email, password: firstPassword }),
    );
  };
        ...
        <Col md="8">
          <ValidatedForm id="register-form" onSubmit={handleValidSubmit}>
            ...
            <ValidatedField
              ...
              validate={{
                required: {
                  value: true,
                  message: 'Se requiere que ingrese una contraseña.',
                },
                minLength: {
                  value: 4,
                  message:
                ...
                maxLength: {
                  value: 50,
                  message: 'Su contraseña no puede tener más de 50 caracteres',
                },
              }}
          ...
          <Alert color="warning">
            ...
            <span>
              ...
              <br />- Administrador (usuario=&quot;admin&quot; y
              contraseña=&quot;admin&quot;) <br />- Usuario
              (usuario=&quot;user&quot; y contraseña=&quot;user&quot;).
            </span>
          </Alert>
        </Col>
      </Row>
