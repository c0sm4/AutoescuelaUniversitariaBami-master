...
public class ScrapingService {
  ...
  public String scrapeData(String dni, String fechaNacimiento, String fechaExamen) {
    try (Playwright playwright = Playwright.create()) {
      ...
      page.navigate("https://sedeclave.dgt.gob.es/WEB_NOTP_CONSULTA/consultaNota.faces");

      // 2. Rellenar el formulario
      log.info("Rellenando el formulario...");
      page.fill("input[id='formularioBusquedaNotas:nifnie']", dni);
      page.fill("input[id='formularioBusquedaNotas:fechaNacimiento']", fechaNacimiento);
      page.fill("input[id='formularioBusquedaNotas:fechaExamen']", fechaExamen);

      // 3. Seleccionar el permiso
      log.info("Seleccionando el permiso...");
      page.selectOption("select[id='formularioBusquedaNotas:clasepermiso']", "B");

      // 4. Enviar el formulario haciendo clic en el botón "Buscar"
      log.info("Enviando el formulario...");
      page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Buscar"))
      ...
      String resultado = page.textContent("div[id^='formularioResultadoNotas:j_id38:0:j_id70']");
      String prueba = log.info("Scraping completado. Resultado: " + resultado);
