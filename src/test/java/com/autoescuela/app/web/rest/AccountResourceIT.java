...
import com.autoescuela.app.IntegrationTest;
import com.autoescuela.app.config.Constants;
import com.autoescuela.app.domain.User;
import com.autoescuela.app.repository.AuthorityRepository;
import com.autoescuela.app.repository.UserRepository;
import com.autoescuela.app.security.AuthoritiesConstants;
import com.autoescuela.app.service.UserService;
import com.autoescuela.app.service.dto.AdminUserDTO;
import com.autoescuela.app.service.dto.PasswordChangeDTO;
import com.autoescuela.app.web.rest.vm.KeyAndPasswordVM;
import com.autoescuela.app.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
  ...
  static Stream<ManagedUserVM> invalidUsers() {
    return Stream.of(
        ...
        createInvalidUser(
            "bob", "123", "Bob", "Green", "bob@example.com", true), // password with only 3 digits
        createInvalidUser(
            "bob", null, "Bob", "Green", "bob@example.com", true) // invalid null password
        );
  }
    ...
    restAccountMockMvc
        .perform(
            post("/api/account/change-password")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                    om.writeValueAsBytes(new PasswordChangeDTO(currentPassword, "new password"))))
        .andExpect(status().isOk());
