...
import static com.autoescuela.app.security.SecurityUtils.AUTHORITIES_KEY;
import static com.autoescuela.app.security.SecurityUtils.JWT_ALGORITHM;
  ...
  public static String createValidTokenForUser(String jwtKey, String user) {
    ...
    JwtClaimsSet claims =
        JwtClaimsSet.builder()
            ...
            .claims(
                customClaim ->
                    customClaim.put(AUTHORITIES_KEY, Collections.singletonList("ROLE_ADMIN")))
            .build();
