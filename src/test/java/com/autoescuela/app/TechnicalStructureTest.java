...
@AnalyzeClasses(
    packagesOf = AutoescuelaUniversitariaApp.class,
...
class TechnicalStructureTest {
  ...
  static final ArchRule respectsTechnicalArchitectureLayers =
      layeredArchitecture()
          ...
          .ignoreDependency(belongToAnyOf(AutoescuelaUniversitariaApp.class), alwaysTrue())
          .ignoreDependency(
              alwaysTrue(),
              belongToAnyOf(
                  com.autoescuela.app.config.Constants.class,
                  com.autoescuela.app.config.ApplicationProperties.class));
}
